                      ...
                      children: <Widget>[
                        Row(
                          children: <Widget>[
                            ...
                            Flexible(child: Text(_data[index]["text"], style: const TextStyle(color: pink, fontSize: 14, fontWeight: FontWeight.w600))),
                          ],
                        ),
                        ...
                        Row(
                          children: <Widget>[
                            ...
                            const SizedBox(width: 10),
                            Flexible(child: Text(formatDate(_data[index]["date"], [yyyy, '-', mm, '-', dd, ', ', HH, ':', MM, ':', ss]), style: const TextStyle(color: pink, fontSize: 14, fontWeight: FontWeight.w600))),
                          ],
                        ),
                      ],
                    ),
